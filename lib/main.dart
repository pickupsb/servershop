...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return ScreenUtilInit(
      designSize: Size(375,784),
      builder: (context, child) {
        return GetMaterialApp(
          getPages: [
            // GetPage(name: '/verificationshopname', page: ()=>VerificationShopNamePage()),
            // GetPage(name: '/VerificationShopAddressPage', page: ()=>VerificationShopAddressPage()),
          ...
          theme: ThemeData(
            ...
            textSelectionTheme: TextSelectionThemeData(cursorColor: Color(0xff008577)),
            dividerTheme: DividerThemeData(color: Color(0xfff0f0f0),thickness: 1.h,),
            ...
            appBarTheme: AppBarTheme(
                ...
                titleTextStyle: TextStyle(color: Colors.black,fontSize: 25.sp,fontWeight: FontWeight.w700),centerTitle: true),
